...
## 功能：
有⼀台復古式遊戲台，按下巨型ENTER鍵後，遊戲就會自動開始，每次可遊玩30秒，按下巨型ENTER鍵即可跳躍。每跨過一個障礙物分數就加1分，撞到障礙物之後分數不歸零，按按鍵就可以繼續遊玩，直到30秒結束。開始遊玩後，如果每成功跳過3個障礙物，燈就會亮⼀種顏⾊，成功跳過12個障礙物之後，燈就會三個都亮起來，代表小恐龍都把顏色找回來了~
## 硬體設備：
- Raspberry pi 3
- 麵包板專⽤線
- 麵包板
